...
<li style="float: right; margin-top: -80px; margin-right:100px;" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style="background-color: transparent;">Kategori Lomba
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="card" style="background-color: white;">
        ...
        <hr>
     <a style ="color:white;" href="detaillomba.php?id=<?=$data['id_lomba']?>"><button>Detail</button> </a>
