...
<?php 
  require('config.php');
  $lomba_data = mysqli_query($conn,"SELECT * FROM lomba WHERE status ='accept'");
...
<br><br>
  <?php 
  require('config.php');
  $lomba_data = mysqli_query($conn,"SELECT * FROM lomba WHERE status = 'accept' AND kategori_lomba ='debat'");
  foreach($lomba_data as $data){
?>
