...
<br>
  ...
  <a href="formiklan.php"> <button name = "iklan" class="btn btn-primary" style="color: black; background-color: #ffc55c; margin-left: 10px; width: 400px; height: 50px; border-radius: 15px; border-color: #ff7315" type="submit"><b>IKLANKAN LOMBA ANDA DISINI!</b></button></a>
<br><br>
  <?php 
  require('config.php');
  $lomba_data = mysqli_query($conn,"SELECT * FROM lomba WHERE status ='publish'");
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="card" style="background-color: white;">
        ...
        <a  style = "color: black" href="detaillomba.php?id=<?=$data['id_lomba']?>"><button style ="color:white; background-color: #3fc5f0; color: black">Detail</button></a> 
      </div>
      </div>
<?php } ?>
</div>
    ...
    <!-- <form action="lkti.php" method="POST" role="form">
    </div>
    <div class="col-sm-4">
      <div class="card" style="background-color: white;">
        <img src="poster3.jpg" alt="Java" style="width:100%;">
        <h4><b>LKTI "Green Technology for Environment Sustainability"</b></h4>
        <p class="price"><b>Rp. 150.000,-</b></p>
        <p style="text-align: left; margin-left: 10px;">Himpunan Mahasiswa Teknik Lingkungan FTSLK ITS mempersembahkan Lomba Karya Tulis Ilmiah sebagai rangkaian acara ENVIRONATION 2019 untuk para siswa SMA/sederajat dan mahasiswa.</p>
        <hr>
        <p><button name = java>Details</button></p>
      </div>
    </div>
    </form>

    <form action="businessplan.php" method="POST" role="form">
    <div class="col-sm-4">
    
      <div class="card" style="background-color: white;">
     
        <img src="poster5.jpg" alt="Java" style="width:100%;">
        <h4><b>Business Plan Competition 2019 Total Hadiah Rp. 15.000.000,-</b></h4>
        <p class="price"><b>Rp. 200.000,-</b></p>
        <p style="text-align: left; margin-left: 10px;">Lomba Diponegoro Entrepreneur Festival (DEF) 2019 merupakan sebuah lomba bisnis plan tingkat nasional yang diselenggarakan oleh BEM Fakultas Teknik Universitas Diponegoro. Info lebih lanjut, klik details berikut!</p>
        <hr>

        <p><button type="submit"name = python>Details</button></p>
