...
<table id="customers">
  ...
  kategori_lomba,url_lomba, periode_iklan, poster_lomba, status, b.bukti_pembayaran FROM lomba INNER JOIN pembayaran b USING(email) ");
...
?>
  <tr>
    ...
    <td>
      ...
      <form action="periodehabis.php" method="post">
        <input type="hidden" name = "idlomba" value="<?php echo $data['id_lomba']; ?>">
       <button style="background-color:red; font-size:14px" type="hapus" name = 'hapus' value="hapus"><p>Delete</p></form></button></td>
  </tr>
